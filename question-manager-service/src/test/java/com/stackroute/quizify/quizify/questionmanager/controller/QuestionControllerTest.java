package com.stackroute.quizify.quizify.questionmanager.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.stackroute.quizify.quizify.questionmanager.domain.Admin;
import com.stackroute.quizify.quizify.questionmanager.domain.Category;
import com.stackroute.quizify.quizify.questionmanager.domain.Question;
import com.stackroute.quizify.quizify.questionmanager.domain.Topic;
...
import com.stackroute.quizify.quizify.questionmanager.service.QuestionService;
...
public class QuestionControllerTest {
    ...
    @Test
    public void getQuestionsSuccessTest() throws Exception {
    ...
    @Test
    public void getQuestionsFailureTest() throws Exception {
        this.questions.add(this.question);
        when(this.questionService.getQuestion((String) any(), (String) any(), (String) any(), anyInt())).thenThrow(NoQuestionFoundException.class);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/categories/{categoryName}/{topicName}/{level}/{numOfQuestions}", this.category.getName(), this.topicMovies.getName(), "easy", 1)
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(this.questions)))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
    ...
    @Test
    public void getAllQuestionsSuccessTest() throws Exception {
        this.questions.add(this.question);
        when(this.questionService.getAllQuestions((String) any(), (String) any())).thenReturn(this.questions);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/categories/{categoryName}/{topicName}", this.category.getName(), this.topicMovies.getName())
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(this.questions)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    @Test
    public void getAllQuestionsFailureTest() throws Exception {
        this.questions.add(this.question);
        when(this.questionService.getAllQuestions((String) any(), (String) any())).thenThrow(NoQuestionFoundException.class);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/categories/{categoryName}/{topicName}", this.category.getName(), this.topicMovies.getName())
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(this.questions)))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
